...
<body>
    ...
    ?>
        ...
        <table class="table table-hover">
            ...
            <?php
                $lista = Retangulo::listar($tipo, $procurar); 
            ...
            ?>
                <tr><td><?php echo $linha['idretangulo'];?></td>
                    ...
                    <td><a href='cadret.php?idretangulo=<?php echo $linha['idretangulo'];?>&processo=editar'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
<path d="M.102 2.223A3.004 3.004 0 0 0 3.78 5.897l6.341 6.252A3.003 3.003 0 0 0 13 16a3 3 0 1 0-.851-5.878L5.897 3.781A3.004 3.004 0 0 0 2.223.1l2.141 2.142L4 4l-1.757.364L.102 2.223zm13.37 9.019.528.026.287.445.445.287.026.529L15 13l-.242.471-.026.529-.445.287-.287.445-.529.026L13 15l-.471-.242-.529-.026-.287-.445-.445-.287-.026-.529L11 13l.242-.471.026-.529.445-.287.287-.445.529-.026L13 11l.471.242z"/>
</svg></a></td>
                    <td><a onclick="return confirm('Deseja excluir?')" href="processoVI.php?idretangulo=<?php echo $linha['idretangulo'];?>&processo=excluir">
...
<path fill-rule="evenodd" d="M2.146 2.146a.5.5 0 0 0 0 .708l11 11a.5.5 0 0 0 .708-.708l-11-11a.5.5 0 0 0-.708 0Z"/>
                    ...
                    <td><a href="mostrarVI.php?idretangulo=<?php echo $linha['idretangulo'];?>&base=<?php echo $linha['base'];?>&altura=<?php echo $linha['altura'];?>&cor=<?php echo str_replace('#', '%23', $linha['cor']);?>&tabuleiro_idtabuleiro=<?php echo $linha['tabuleiro_idtabuleiro']?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
